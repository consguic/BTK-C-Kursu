//
// Created by fatma on 28/02/2024.
//
...
//Turetilmis degiskenler
int array[4] = {1,2,3,4}; //ayni turden bircok degiskenin bir araya getirildigi statik liste
//pointer
//function

//Kullanici tanimlilar
//struct
//union
//enum
